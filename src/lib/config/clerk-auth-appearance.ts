export const authAppearance = {
  ...
  elements: {
    ...
    form: "flex flex-col gap-1.5 overflow-visible",
    formField: "space-y-1 m-0 p-0 overflow-visible",
    formFieldRow: "m-0 p-0 overflow-visible",
    formFieldLabelRow: "flex items-center justify-between w-full m-0 p-0",
