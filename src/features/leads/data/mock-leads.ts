    ...
    objections: [
      {
        ...
        severity: "low",
        status: "resolved",
        resolutionNote: "Facility management SLA verified and dispatched via verified email.",
...
const RAW_MOCK_LEADS: Lead[] = [
  {
    ...
    activities: [
      ...
      },
      {
        id: "act_103",
        type: "human_note",
        title: "Executive Email Brochure & Itinerary Dispatched",
        description: "Sent architectural layout PDF and high-res photo gallery via verified email dispatch.",
        timestamp: "6m ago",
        channel: "Corporate Mail Server",
        status: "completed",
        actor: {
          type: "system",
  ...
  },
  {
    ...
    intent: "Investment",
    timeline: "3 months",
    nextAction: "Second automated outreach via Email",
    createdAt: "2h ago",
    ...
    nextActionDirective: {
      action: "Trigger Second Autonomous Email Touchpoint",
      assignedTo: "Autonomous AI Engine",
      priority: "Routine",
...
export const MOCK_DAY13_EXTENSIONS: Record<string, Partial<Lead>> = {
  lead_01: {
    managementMode: "ai_autonomous",
    isAiStopped: false,
    recommendedAction: {
      title: "Verify Governor's Consent Title Copy",
      directive: "Prospect requested legal title deed verification before tomorrow's 2:30 PM inspection.",
      priority: "Immediate",
      suggestedChannel: "email",
      actionProtocol: "Dispatch verified deed registry number and surveyor clearance memorandum via corporate email.",
      dueTimeFormatted: "Within 2 hours",
    },
    handoffContext: {
      triggerReason: "High-value asset tier ($85M outright) & imminent viewing scheduled",
      triggerCategory: "high_value",
      synthesis: "Prospect is 100% liquid and tenancy expires in 45 days. Needs final confirmation on facility management generator SLA.",
      keyQuotes: [
        "I have the ₦85M liquid in my corporate account, but I want to be 100% sure the title is clean Governor's Consent.",
      ],
    ...
    followUpSchedule: {
      ...
      scheduledFormatted: "Tomorrow, Sep 20 • 2:30 PM",
      relativeCountdown: "Tomorrow",
      channel: "call",
      cadence: "once",
      notes: "Pre-inspection call 30 mins before gate access at Lekki Phase 1.",
    },
  },
  lead_02: {
    managementMode: "ai_autonomous",
    isAiStopped: true,
    aiStoppedReason: "Broker requested pause to review KYC and spouse flight schedule before next voice touchpoint.",
    recommendedAction: {
      title: "Review Diaspora Relocation Tax Pack",
      directive: "Prepare offshore tax repatriation brief ahead of spouse's arrival in Lagos next week.",
      priority: "Scheduled",
      suggestedChannel: "email",
      actionProtocol: "Email structured offshore buyer advisory and dual-currency escrow options.",
      dueTimeFormatted: "By Friday, 5:00 PM",
    },
    followUpSchedule: {
      scheduledAt: "2026-09-22T10:00:00Z",
      scheduledFormatted: "Tue, Sep 22 • 10:00 AM",
      relativeCountdown: "In 3 days",
      channel: "call",
      cadence: "weekly",
      notes: "Follow up once spouse lands in Lagos for joint viewing coordination.",
    },
  },
  lead_03: {
    ...
    handoffContext: {
      triggerReason: "Price negotiation keyword detected: prospect proposed ₦130M on ₦140M asking price",
      triggerCategory: "negotiation",
      synthesis: "Prospect has sole signing authority and requested a ₦10M discount for 100% upfront wire transfer. AI safely halted pricing discussion per safety guardrails.",
      keyQuotes: [
        "Can the developer accept ₦130M cash if I transfer the entire balance this Friday?",
      ],
    ...
    recommendedAction: {
      ...
      directive: "Engage prospect directly to present ₦135M developer compromise with inclusion of 12-month free service charge.",
      priority: "Immediate",
      suggestedChannel: "call",
      actionProtocol: "Call prospect on direct line. Affirm cash readiness, counter at ₦135M, and offer immediate deed reservation lock.",
      dueTimeFormatted: "Immediate (within 15 mins)",
    },
    followUpSchedule: {
      scheduledAt: "2026-09-20T11:00:00Z",
      scheduledFormatted: "Tomorrow, Sep 20 • 11:00 AM",
      relativeCountdown: "Tomorrow",
      channel: "call",
      cadence: "daily",
      notes: "Confirm counter-offer acceptance or schedule developer executive sit-down.",
    },
  },
  lead_04: {
    managementMode: "ai_autonomous",
    isAiStopped: false,
    recommendedAction: {
      title: "Send Video Walkthrough of Maisonette",
      directive: "Prospect expressed strong interest in high-ceiling living layout.",
      priority: "Scheduled",
      suggestedChannel: "email",
      actionProtocol: "Dispatch 4K architectural drone video via corporate email.",
      dueTimeFormatted: "Today by 4:00 PM",
    },
  },
  lead_05: {
    status: "Nurture",
    ...
    followUpSchedule: {
      ...
      scheduledFormatted: "Oct 4, 2026 • 10:00 AM",
      relativeCountdown: "In 14 days",
      channel: "email",
      cadence: "biweekly",
      notes: "Check in on offshore funds repatriation progress from London account.",
    },
    recommendedAction: {
      title: "Bi-Weekly Email Market Intelligence",
  ...
  lead_08: {
    ...
    managementMode: "lost",
    isAiStopped: true,
    aiStoppedReason: "Lead marked as lost due to budget mismatch below developer minimum threshold.",
    lossDetails: {
      reason: "budget_mismatch",
      reasonLabel: "Budget Below Minimum Entry Floor",
      notes: "Prospect budget ceiling is ₦42M; prime Ikoyi inventory requires ₦85M minimum entry floor.",
      lostAt: "2 days ago",
    },
  },
};
